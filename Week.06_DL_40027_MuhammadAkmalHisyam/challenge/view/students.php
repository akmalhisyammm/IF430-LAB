            ...
            <table id="studentsTable" class="table table-striped table-bordered" style="width: 100%">
              ...
              <tbody>
                ...
                while ($row = $result->fetch()) {
                  array_push($student, new Student($row['id'], $row['student_id'], $row['first_name'], $row['last_name']));
                  $i++;
                }
                foreach ($student as $row) {
                  echo "<tr>";
                  echo "<td>" . $row->getId() . "</td>";
                  echo "<td>" . $row->getStudentId() . "</td>";
                  echo "<td>" . $row->getFirstName() . "</td>";
                  echo "<td>" . $row->getLastName() . "</td>";
                  echo "<td><a href='delete_student.php?id=" . $row->getId() . "' style='color: #000'><i class='fa fa-times-circle'></i></a>" . "<br>" . "<a href='edit_student.php?id=" . $row->getId() . "' style='color: #000'><i class='fa fa-wrench'></i></a> </td>";
                  echo "</tr>";
                }
                ?>
              </tbody>
